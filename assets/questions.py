...
**⛔ מה לא נכנס — זה קריטי, ובלעדיו הרשימה מתמלאת ברעש:**

- **שאלות שיחה** — "את יודעת מה אני מתכוון?", "נכון?", "מה?", "אה?"
  אלה טיקים של דיבור. הן חוזרות בכל פגישה ואין בהן שום מידע
- **שאלות לוגיסטיות** — "מתי הפגישה הבאה?", "שלחת לי את זה?", "אפשר להקליט?"
- **שאלות שהיועץ שאל את הלקוח** — רק מה שהלקוח שאל
- **שאלות רטוריות** שהשואל ענה עליהן בעצמו מיד

**✅ מה כן:** שאלה שהלקוח באמת רצה עליה תשובה, ושהתשובה עליה מלמדת משהו
על התחום. הרף: **האם מישהו אחר בעולם היה שואל את זה?**
